...
func (_m *MockDB) Begin(_a0 context.Context) (pgx.Tx, error) {
	ret := _m.Called(_a0)
...
//   - _a0 context.Context
func (_e *MockDB_Expecter) Begin(_a0 interface{}) *MockDB_Begin_Call {
	return &MockDB_Begin_Call{Call: _e.mock.On("Begin", _a0)}
}

func (_c *MockDB_Begin_Call) Run(run func(_a0 context.Context)) *MockDB_Begin_Call {
