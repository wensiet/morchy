...
\includepdf[pages=-, offset=70 -80]{thesis_title.pdf}
\tableofcontents
\listoftables
\listoffigures
\newpage
...
% numbering runs continuously from the title page (1) through contents (2-4),
% list of tables (5), list of figures (6-8) and abstract (9); pin the first
% chapter to 10 so the body stays aligned if front-matter length shifts
\setcounter{page}{10}
