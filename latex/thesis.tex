...
\includepdf[pages=-, offset=70 -80]{title_v2.pdf}
\tableofcontents
\listoftables
\listoffigures
\newpage
...
% the `abstract` environment uses \titlepage internally, which resets the page
% counter to 1; restore it here so numbering stays continuous from the title page
% (1) through contents (2-4), list of tables (5), list of figures (6-8), abstract (9)
\setcounter{page}{10}
